...
AbstractQuickPanel {
    ...
    // Toggles
    readonly property list<string> availableToggleTypes: ["network", "bluetooth", "idleInhibitor", "easyEffects", "nightLight", "darkMode", "clashVerge", "gameMode", "screenSnip", "colorPicker", "onScreenKeyboard", "mic", "audio", "notifications", "powerProfile","musicRecognition", "antiFlashbang"]
                ...
                delegate: ButtonGroup {
                    ...
                    Repeater {
                        ...
                        delegate: AndroidToggleDelegateChooser {
                            ...
                            onOpenClashVergeDialog: root.openClashVergeDialog()
                        }
                    }
                }
            }
