...
remove_deprecated_dependencies(){
  ...
  list+=({quickshell,hyprutils,hyprpicker,hyprlang,hypridle,hyprland-qt-support,hyprland-qtutils,hyprlock,xdg-desktop-portal-hyprland,hyprcursor,hyprwayland-scanner,hyprland-hidpi-xprop}-git)
  list+=(matugen-bin)
